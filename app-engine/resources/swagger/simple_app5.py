...
from flask_restplus import Api, Resource, fields, marshal, Namespace  # noqa: E402


app = Flask(__name__)
app.wsgi_app = ProxyFix(app.wsgi_app)
api = Api(app, title='Example YT API Docs', description='this is an example docs', version='1.0.0',
default = 'Example API', validate=True, skip_none=True)
